<?php
/**
 * Каталог товаров для кассы (10.09.2026). Поиск, фильтры, переход в карточку.
 *
 * Показываем ТОЛЬКО своё направление — фильтр по `kod_sap` внутри catalog_search(), а не по `ref`
 * и не по категории (см. правила проекта: ref у Жоми и Турк пересекается).
 * Закупочных цен и поставщиков здесь нет: решение пользователя от 10.09.2026.
 */
...
?>
<div class="card">
  <h1>Каталог товаров <span class="muted">— <?= htmlspecialchars($cfg['direction_label']) ?></span></h1>
