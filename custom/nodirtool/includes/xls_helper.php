 ...
 * Портировано из TeplouxKassa/includes/xls_helper.php (файл проектно-независимый, без изменений).
 */
...
function xls_common_styles()
{
  ...
  <Style ss:ID="CellWrap">
   <!-- UX-N3 (внешний отчёт, 02.09.2026, NodirTool cost_report_excel.php): для ячеек с несколькими
        видами расходов на одну строку — каждый вид на своей строке внутри ячейки, а не одна длинная
        строка через запятую. Значение должно содержать реальные символы новой строки. -->
  ...
  <Style ss:ID="PartialQty">
   <!-- N-1 (03.09.2026): количество принято меньше заказанного — себестоимость посчитана от
        заказанного, часть расходов приходится на непривезённое. Подсветка, чтобы это было видно
        и в скачанном файле, а не только на экране. -->
   <Alignment ss:Horizontal="Center"/>
